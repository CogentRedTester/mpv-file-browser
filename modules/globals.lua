...
local BODY_SCALING = math.floor(o.scaling_factor_body * 100)
...
globals.style = {
    ...
    body = ([[{\r\q2\fs%d\fscx%d\fscy%d\fn%s\c&H%s&}]]):format(BASE_FONT_SIZE, BODY_SCALING, BODY_SCALING, o.font_name_body, o.font_colour_body),
